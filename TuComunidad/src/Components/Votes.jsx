        ...
        return (
            ...
            <div className='row'>
                <div className='col-md-4 '>
                    <div>
                        <h2 style={{fontSize: '30px', color: '#757575', marginBottom: '35px'}}>Votos</h2>
                    </div>
                    <table style={{width: '250px'}}>
                        <tbody>
                        {this.state.votes.length===0?
                            <tr align="center"><td colSpan="5">No encontrado</td></tr>:
                        ...
                        <div className="form-group">
                            <div className='row'>
                                <div className='col-md-6'>
                                    <input type="radio" value="1" name="gender" onChange={this.onVoteFavourOrAgainstValueChange} /> A Favor
                                </div>
                                <div className='col-md-6'>
                                    <input type="radio" value="2" name="gender" onChange={this.onVoteFavourOrAgainstValueChange} /> En Contra
                                </div>
                                <p>{this.state.vote.description}</p>
                            </div>
                        </div>
                        <div className="form-group">
                            {this.state.isNeighbourVoteAlready ? "" : <button className="btn btn-success">Votar</button>}
                        </div>
                    </form>
                </div>
            </div>
